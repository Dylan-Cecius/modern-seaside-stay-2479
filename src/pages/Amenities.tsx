...
import { Heart, Dumbbell, Waves, Coffee, Utensils, Wine, Clock, Car, Plane, Car as CarIcon, MapPin, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Heart key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <Coffee key={3} />],
