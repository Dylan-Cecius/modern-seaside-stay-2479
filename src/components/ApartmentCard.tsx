  ...
  return <div className="rounded-xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-xl bg-card group" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          {apartment.features.slice(0, 3).map((feature, index) => <div key={index} className="flex items-center text-sm text-muted-foreground bg-muted px-3 py-1 rounded-full">
          ...
          {apartment.features.length > 3 && <div className="text-sm text-muted-foreground bg-muted px-3 py-1 rounded-full">
